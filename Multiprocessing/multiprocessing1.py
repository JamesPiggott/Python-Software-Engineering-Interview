'''
  ...
  This is is an example project showing how to spawn more processes using multiprocessing API

  This example is inspired by the Youtube tutorial by LucidDreams @ https://www.youtube.com/watch?v=RR4SoktDQAw
